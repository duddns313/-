...
const STORY = {
  chapters: [
    ...
    },
    {
      ...
      setFlag: 'ch1_done',
      title: '단서 보고',
      text: '영운은 낡은 일기장을 덤블도어 교수에게 보여준다.\n그는 눈을 가늘게 뜨며 말한다.\n"이건... 예전에 이 학교를 다녔던 누군가의 일기로군. 필체가 낯이 익어. 영운 군, 금지된 숲에 무언가 더 있을지도 모르겠네."',
    ...
    },
    {
      ...
      setFlag: 'ch2_done',
      title: '2장. 금지된 숲의 흔적',
      text: '금지된 숲에서 찾은 녹슨 열쇠를 교수에게 보여주자, 그의 표정이 굳는다.\n"이 열쇠는... 오래전 봉인되었던 방으로 통하는 것일세. \'비밀의 방\'이라 불리던 곳이지. 영운 군, 자네가 가려는가?"',
