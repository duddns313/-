...
const CACHE_NAME = "hogwarts-shade-v10";
...
const ASSETS = [
  ...
  './js/systems/item.js', './js/systems/loot.js', './js/systems/spell.js',
  './js/systems/loadout.js', './js/systems/duel.js', './js/systems/achievement.js',
